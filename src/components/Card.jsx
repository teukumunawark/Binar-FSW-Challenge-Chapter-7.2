      ...
      <div className="max-w-md bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700 p-5">
        ...
        <div className="pt-5 space-y-2">
          <p className='font-poppins font-medium'>
            {`${data.manufacture} ${data.model}`} - {(data.available == true) ? "(Dengan Driver)" : "(Tanpa Driver)"}</p>
          ...
          <div className='text-gray-500 space-y-4 pt-3'>
            <p className='font-poppins font-medium flex items-center gap-3'><FiUsers className=' text-[22px]' />
              {data.capacity}</p>
